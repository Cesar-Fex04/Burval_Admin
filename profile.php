...
if (isset($updateUser)) {
 ...
 <div class="card ">
   <div class="card-header">
          <h3 style="text-align: center;">User Profile <span class="float-right"> <a href="index.php" class="btn btn-primary">Back</a> </h3>
        </div>
        <div class="card-body">
    ...
    if ($getUinfo) {
     ...
     ?>
          ...
          <div style="width:50%; margin:0px auto; margin-top:5%">
